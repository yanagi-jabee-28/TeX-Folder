...
しかし，電気信号は周波数が高くなればなるほど，基板を通るときに弱まってしまう（信号減衰）．この減衰を正確に見積もることが，高性能な通信機器を作る上で不可欠となっている\cite{soumu2022beyond5g}．
...
これまで，多くの研究は「1. 誘電損失」の評価に集中していた．しかし，周波数が高くなると，電気は配線の表面スレスレしか流れなくなる（表皮効果）．その結果，配線表面にあるわずかな「粗さ（凸凹）」が電気の流れを邪魔し，無視できない損失を生むことになる\cite{fukuda2021transmission}．
