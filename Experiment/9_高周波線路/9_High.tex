...
\noindent
\begin{tabular}{@{}ll}
  \BoldLabel{テーマ名} & \UnderlineBox[13.5cm]{9. 高周波線路の電流分布特性} \\[2.0em] 
\end{tabular}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{10cm}{\centering \vspace{3cm} 図1画像プレースホルダ \vspace{3cm}}}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{10cm}{\centering \vspace{3cm} 図2画像プレースホルダ \vspace{3cm}}}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{8cm}{\centering \vspace{2cm} 図3画像プレースホルダ \vspace{2cm}}}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{10cm}{\centering \vspace{2cm} 図4画像プレースホルダ \vspace{2cm}}}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{10cm}{\centering \vspace{2cm} 図5画像プレースホルダ \vspace{2cm}}}
    \caption{測定系（断面）}
...
\begin{figure}[H]
    ...
    \fbox{\parbox{8cm}{\centering \vspace{3cm} 図6画像プレースホルダ \vspace{3cm}}}
