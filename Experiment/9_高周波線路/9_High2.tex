...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \begin{tikzpicture}
        \begin{axis}[width=\linewidth, xlabel={位置 $x$ (mm)}, ylabel={短絡 (dB$\mu$V)}, grid=both, unbounded coords=jump]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \begin{tikzpicture}
        \begin{axis}[width=\linewidth, xlabel={位置 $x$ (mm)}, ylabel={解放 (dB$\mu$V)}, grid=both, unbounded coords=jump]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \begin{tikzpicture}
        \begin{axis}[width=\linewidth, xlabel={位置 $x$ (mm)}, ylabel={整合 (dB$\mu$V)}, grid=both, unbounded coords=jump]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \begin{tikzpicture}
        \begin{axis}[width=\linewidth, xlabel={位置 $x$ (mm)}, ylabel={半端もの (dB$\mu$V)}, grid=both, unbounded coords=jump]
