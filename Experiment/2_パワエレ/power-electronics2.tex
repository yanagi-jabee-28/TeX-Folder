...
\section{実験結果}
% 警告回避のポイント: 
% 1. header=false を追加し、数値データの誤読を防ぐ
% 2. width=0.95\linewidth に設定し、Overfull \hbox を回避
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \begin{tikzpicture}
        \begin{axis}[xlabel=時間(秒),ylabel=回転数(\,rpm\,),width=0.95\linewidth,height=5cm]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \begin{tikzpicture}
        \begin{axis}[xlabel=時間(秒),ylabel=電源電圧(\,V\,),width=0.95\linewidth,height=5cm]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \begin{tikzpicture}
        \begin{axis}[xlabel=時間(秒),ylabel=インバータ出力電力(\,W\,),width=0.95\linewidth,height=5cm]
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \begin{tikzpicture}
        \begin{axis}[xlabel=時間(秒),ylabel=トルク(\,Nm\,),width=0.95\linewidth,height=5cm]
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \begin{tikzpicture}
        \begin{axis}[xlabel=時間(秒),ylabel=電源電力(\,W\,),width=0.95\linewidth,height=5cm]
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \begin{tikzpicture}
        \begin{axis}[xlabel=時間(秒),ylabel=速度(\,rpm\,),width=0.95\linewidth,height=5cm]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \begin{tikzpicture}
        \begin{axis}[xlabel=時間(秒),ylabel=電流設定値/測定値(\,A\,),width=0.95\linewidth,height=5cm]
