...
\section{実験結果}
測定結果の抜粋を\cref{tab:result}に，周波数応答のグラフを\cref{fig:bode}に示す。共振周波数付近（$\SI{707.3}{Hz}$）において，明瞭なゲインのピークが観測された。
...
\begin{figure}[H]
    ...
    \addplot[mark=*, blue, thick, mark size=1.5pt] coordinates {
        (99.6,0) (103.7,0.12) (151.7,0.21) (201.7,0.56) (303.4,1.19)
        (499.7,3.33) (600,4.21) (650,5.36) (707.3,5.90) (746,5.17)
        (1013,0.12) (1559,-9.90) (3050,-21.79) (5001,-25.68) (6936,-31.06)
    };
    \addlegendentry{Experimental}
    \end{semilogxaxis}
    \end{tikzpicture}
    \caption{実験結果：ゲイン特性（ボード線図）}
    \label{fig:bode}
\end{figure}
...
\cref{fig:bode}より，共振周波数以降の減衰特性を確認すると，周波数が10倍になるごとの減衰（ロールオフ）は理論的な $-40\,\si{dB}/\text{dec}$ に近似している（例：$3\,\si{kHz}$ で約$-22\,\si{dB}$，$7\,\si{kHz}$ で約$-31\,\si{dB}$）。また，位相特性においても，低周波域の $0^\circ$ から高周波域の $-180^\circ$ へ推移しており，共振点付近で $-90^\circ$ を通過している。これらの周波数応答の特徴は2次遅れ系の理論的挙動と一致しており，本アクティブフィルタは2次遅れ系として正常に機能していると結論付けられる。
