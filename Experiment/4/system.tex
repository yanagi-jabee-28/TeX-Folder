...
\begin{equation}
    \ze_{\text{exp}} = \sqrt{\frac{1 - \sqrt{1 - \frac{1}{1.973^2}}}{2}} \approx \mathbf{0.263}
\end{equation}
と算出される。
次に，共振角周波数 $\omega_p = 2\pi f_p$ の関係式 $\omega_p = \wn\sqrt{1-2\ze^2}$ より，固有角周波数 $\wn$ を逆算する。
\begin{equation}
    \omega_{n,\text{exp}} = \frac{2\pi \cdot 707.3}{\sqrt{1 - 2(0.263)^2}} = \frac{4444.1}{\sqrt{0.8616}} \approx \mathbf{\SI{4787}{rad/s}}
\end{equation}
以上より，実験結果に基づく伝達関数 $G_{\text{exp}}(s)$ は次式となる。
\begin{equation}
    G_{\text{exp}}(s) = \frac{4787^2}{s^2 + 2(0.263)(4787)s + 4787^2} = \frac{2.29 \times 10^7}{s^2 + 2518s + 2.29 \times 10^7}
\end{equation}
