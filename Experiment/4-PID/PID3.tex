...
% キャプション設定
% ラベルと本文を本文と同じ（ローマン）フォントに揃える
% 確実に本文（ローマン）フォントを使用するため、rmfamily を明示
\captionsetup[table]{name=表, labelsep=quad, labelfont={bf,rmfamily}, textfont={rmfamily}, justification=centering, singlelinecheck=false}
\captionsetup[figure]{name=図, labelsep=quad, labelfont={bf,rmfamily}, textfont={rmfamily}, justification=centerlast}
...
% 図・表・数式等の番号を本文と同じ（ローマン）フォントにする
\makeatletter
\renewcommand{\thefigure}{\normalfont\arabic{figure}}
\renewcommand{\thetable}{\normalfont\arabic{table}}
