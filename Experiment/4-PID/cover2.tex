...
% ===== 基本設定 =====
% 下余白を少し詰めて(20mm)、確実に収まるように調整
\usepackage[top=25mm, bottom=20mm, left=18mm, right=18mm]{geometry}
\usepackage{array}      
\usepackage{multirow}   
\usepackage{fancyhdr}   
\usepackage{amssymb}    
...
\begin{center}
    ...
    \vspace{10mm} % タイトル下の余白を圧縮 (20mm -> 10mm)
\end{center}
...
\UnderlineBox[4.5cm]{}                                         
\vspace{2.0em} % 余白を圧縮 (3.5em -> 2.0em)
...
\vspace{2.5em} % 余白を圧縮 (4.0em -> 2.5em)

% --- 日付セクション ---
% 行間を少し詰める (2.5 -> 2.0) それでも十分書きやすい
\noindent
