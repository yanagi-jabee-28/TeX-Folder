...
\clearpage
以下は課題1〜4で使用したプログラムのリストである．

\lstinputlisting[language=Python,caption={report\_image\_analysis2 用 Python スクリプト},label={lst:python-code}]{report_image_analysis2.py}
