...
結論: 画質指標は \textbf{Q=80} で SSIM=0.783、\textbf{Q=90} で 0.825 と向上するが、サイズ比は 11.8\%→17.7\%へ増加。視覚・数値の両面から、報告用途では \textbf{Q=80～90} が妥当。\textbf{Q=100} はSSIM向上が小さい一方でサイズ比 45.5\% と非効率。
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{a2-5_gray_image_magnitude_spectrum.png}
