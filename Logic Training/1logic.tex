...
\usepackage{anyfontsize} % 任意のフォントサイズを許可し、サイズ置換警告を回避
\usepackage{lmodern} % Latin Modern フォントを正しくロードし、フォント形状警告を回避
...
% 欧文（本文）: Latin Modern Roman を使用（安定した選択）
\setmainfont{Latin Modern Roman}[Ligatures=TeX,NFSSFamily=lmr]
