...
% --- 数式関連パッケージ (amsmathを先に読み込む) ---
\usepackage{amsmath}

% --- フォント関連パッケージ (amssymbの機能はnewtxmathに含まれる) ---
\usepackage{newtxtext, newtxmath}
% \usepackage{amssymb} % ← newtxmathと競合するため、この行を削除またはコメントアウト
...
\usepackage{hyperref} % hyperrefは最後に読み込むのが安全
