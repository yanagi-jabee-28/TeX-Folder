...
一方、仮定（左辺）は $(p_1 \land p_2) \lor (q_1 \land q_2)$ である。
論理和の導入則 $A \implies A \lor B$ より、
\[ (p_1 \land p_2) \lor (q_1 \land q_2) \implies (p_1 \land p_2) \lor (q_1 \land q_2) \lor \underbrace{(p_1 \land q_2) \lor (q_1 \land p_2)}_{\text{追加項}} \]
したがって、左辺 $\implies$ 右辺 が成立する。
\end{proof}
